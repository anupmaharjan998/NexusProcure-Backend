...
namespace NexusProcure.Infrastructure.Migrations
{
    ...
    [Migration("20250927140715_InitialCreate")]
            ...
            modelBuilder.Entity("NexusProcure.Core.Entities.Role", b =>
                {
                    ...
                    b.HasData(
                        ...
                        new
                        {
                            Id = new Guid("11111111-1111-1111-1111-111111111000"),
            ...
            modelBuilder.Entity("NexusProcure.Core.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            FullName = "",
                            PasswordHash = "$2a$11$y9F3ZBoHxlzE7x9/.R7KQ.9XasZDfWPGhKpD3gLE2/J6ZfCqzDq6a",
                            RoleId = new Guid("11111111-1111-1111-1111-111111111100"),
                            Username = "admin"
                        });
                });
